...
//
const APP_NAME: string    = "WHY WONT IT WORK";   // did this during testing... kind of fitting
const APP_VERSION: string = "0.0000000001";   // same as above
...
var _MemoryAccessor: TSOS.MemoryAccessor; // Software (OS)
